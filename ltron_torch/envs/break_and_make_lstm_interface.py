...
from ltron_torch.envs.utils import (
    bernoulli_or_max,
    categorical_or_max,
...
class BreakAndMakeLSTMInterface:
    ...
    def observation_to_tensors(self, observation, pad, device=None):
        '''
    ...
    def format_frames(self, frames, device):
    ...
    def loss(self, x, pad, y, log=None, clock=None):
        '''
        Compute loss from model output using gym actions as supervision
        '''
        s, b = x['mode'].shape[:2]
